...
BETFAIR_ONLY_MODE = env("BETFAIR_ONLY_MODE", "false").lower() in {"1", "true", "yes", "on"}
...
ODDSPAPI_MAX_BOOKMAKERS = int(env("ODDSPAPI_MAX_BOOKMAKERS", "5"))
...
SUPPORTED_MARKETS = ["MATCH_ODDS","MATCH_ODDS_HT","DOUBLE_CHANCE","BTTS","DRAW_NO_BET","CORRECT_SCORE","CORRECT_SCORE_HT","OVER_UNDER_05","OVER_UNDER_15","OVER_UNDER_25","OVER_UNDER_35","OVER_UNDER_45","OVER_UNDER_55","OVER_UNDER_65","OVER_UNDER_75","OVER_UNDER_85","OVER_UNDER_HT_05","OVER_UNDER_HT_15","OVER_UNDER_HT_25"]
