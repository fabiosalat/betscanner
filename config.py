...
BETFAIR_CERT_FILE = env("BETFAIR_CERT_FILE", os.path.join(tempfile.gettempdir(), "betscanner-betfair", "client.crt"))
BETFAIR_KEY_FILE = env("BETFAIR_KEY_FILE", os.path.join(tempfile.gettempdir(), "betscanner-betfair", "client.key"))
